...
const LAB_SUPPLIES: Product[] = [
  ...
  {
    id: 'lab-insulin-syringe-29g',
    name: 'Insulin Syringes 1mL / 29G (10-pack)',
    price: 9.99,
    category: 'Accessories',
    quantityLabel: '10 syringes',
    description: 'Ultra-fine 29-gauge, 1mL insulin syringes with half-unit markings. Ideal for precise reconstitution and dosing of research peptides.',
    form: 'Disposable Syringe',
    purity: 'Sterile / Single-Use',
    storage: 'Store in original packaging, dry environment',
    image: 'https://images.pexels.com/photos/4226119/pexels-photo-4226119.jpeg?auto=compress&cs=tinysrgb&w=400',
  },
  {
